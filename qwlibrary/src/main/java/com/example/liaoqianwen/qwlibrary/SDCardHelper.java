package com.example.liaoqianwen.qwlibrary;
...
/**
 * Android的存储分为内部存储器/data/.... 和外部存储器/mnt/...或者/storage/...   此类为文件（存储器）操作工具类
 *
 * 有包名的路径我们都是调用Context中的方法来获得，没有包名的路径，我们直接调用Environment中的方法获得，那么其中有两个方法需要传入一个String类型的参数，
 * 这个参数我们使用了Environment中的常量，参数的意思是我们要访问这个路径下的哪个文件夹，比如getExternalFilesDir方法
 *
 * Created by liaoqianwen on 2016/8/23.
 */
